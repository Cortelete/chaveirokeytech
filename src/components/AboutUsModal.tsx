  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Quem Somos">
      <div className="space-y-4 text-slate-300 leading-relaxed text-sm sm:text-base">
        ...
        <p>
          Nossa expertise abrange chaves codificadas, imobilizadores, e reparo avançado de painéis e módulos ECU. 
          Trabalhamos com equipamentos de ponta para garantir um serviço rápido, seguro e eficiente.
        </p>
        <p>
          Nosso compromisso é entregar não apenas um serviço, mas a tranquilidade de saber que seu veículo está em mãos de especialistas.
        </p>
      </div>
    </Modal>
  );
